...
|   | Run | View |
| - | --- | ---- |
| Fitting individual subjects’ empirical TEPs | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Davi1990/PyTepFit/blob/main/nb/model_fit.ipynb) | [![View the notebook](https://img.shields.io/badge/render-nbviewer-orange.svg)](https://nbviewer.jupyter.org/github/Davi1990/PyTepFit/blob/main/nb/model_fit.ipynb?flush_cache=true) |


|   | Run | View |
| - | --- | ---- |
| Goodness of Fit | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Davi1990/PyTepFit/blob/main/nb/Goodness_of_fit.ipynb) | [![View the notebook](https://img.shields.io/badge/render-nbviewer-orange.svg)](https://nbviewer.jupyter.org/github/Davi1990/PyTepFit/blob/main/nb/model_fit.ipynb?flush_cache=true) |
...
|   | Run | View |
| - | --- | ---- |
| Params exploration | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Davi1990/PyTepFit/blob/main/nb/Params_exploration.ipynb) | [![View the notebook](https://img.shields.io/badge/render-nbviewer-orange.svg)](https://nbviewer.jupyter.org/github/Davi1990/PyTepFit/blob/main/nb/model_fit.ipynb?flush_cache=true) |
